function [trainedClassifier, validationAccuracy] = trainFCNN(trainingData, responseData)
...
% Auto-generated by MATLAB on 19-May-2022 11:23:34
...
classificationNeuralNetwork = fitcnet(...
    predictors, ...
    response, ...
    'LayerSizes', [17 54 293], ...
    'Activations', 'sigmoid', ...
    'Lambda', 0.0001385491628694712, ...
    'IterationLimit', 1000, ...
    'Standardize', false, ...
    'ClassNames', categorical({'0'; '2'; '3'; '4'; '5'}));
